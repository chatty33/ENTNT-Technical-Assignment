...
let initialOrders = [
  ...
  { id: 5, orderId: 'ORD005', customerName: 'Bob Williams', orderDate: '2024-03-18', status: 'Processing', expectedDeliveryDate: new Date() },
  { id: 6, orderId: 'ORD006', customerName: 'Emily Brown', orderDate: '2024-03-19', status: 'Pending', expectedDeliveryDate: new Date() },
  { id: 7, orderId: 'ORD007', customerName: 'Michael Davis', orderDate: '2024-03-20', status: 'Processing', expectedDeliveryDate: new Date() },
  { id: 8, orderId: 'ORD008', customerName: 'Sarah Wilson', orderDate: '2024-03-21', status: 'Delivered', expectedDeliveryDate: new Date() }
];
